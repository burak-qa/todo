...
class App extends Component {
  ...
  if(this.state.todoError === "") this.setState({todoError : "please Enter an to do! "})
  if(this.state.descriptionError === "") this.setState({descriptionError : "please Enter an explanation "})
